...
with tabs[3]:
    ...
    # Gráfico Pizza de renda
    graf_pizza = px.pie(
        renda,
        names="Dados de Renda",
        values="Quantidade",
        hole=0.3,
        title="Dados de Renda dos Participantes"
    )
    st.plotly_chart(graf_pizza)
...
with tabs[5]:
    ...
    # Gráfico Carros
    st.bar_chart(df_filtrado["Q010"].value_counts())
    
    st.subheader("Dados de Transporte - Motos")
    # Gráfico Motos
    st.bar_chart(df_filtrado["Q011"].value_counts())
